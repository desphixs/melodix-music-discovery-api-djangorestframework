...
urlpatterns = [
    ...
    # Route for retrieving and creating collaborative comments linked to a specific playlist ID.
    # '<int:playlist_id>' captures the specific playlist's ID integer from the URL and passes it directly to our view.
    path('playlists/<int:playlist_id>/comments/', PlaylistCommentsAPIView.as_view(), name='playlist-comments'),
]
